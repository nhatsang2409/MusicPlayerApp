...
class DownloadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val databaseUrl = "https://musicplayer-2fce0-default-rtdb.asia-southeast1.firebasedatabase.app"
        ...
        musicAdapter.setOnItemClickListener { position ->
            ...
            AlertDialog.Builder(this)
                ...
                .setNeutralButton("Tải về") { dialog, _ ->
                    downloadMusic(music.title, music.album, music.artist, music.path, music.artUri)
                    dialog.dismiss()
                }
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for (userSnap in snapshot.children) {
                        for (item in userSnap.children) {
                            ...
                            val artUri = item.child("artUri").getValue(String::class.java) ?: ""
    ...
    private fun downloadMusic(title: String, album: String, artist: String, fileUrl: String, artUri: String) {
        try {
            ...
            val newLocalSong = Music(
                ...
                artUri = artUri              // Chưa có ảnh album
            )
